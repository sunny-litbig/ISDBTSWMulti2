...
STATIC	:=.a
SHARED	:=.so
LOCAL_TARGET := libTCCSWMulti2_linux
...
LOCAL_SRC_FILES += $(LOCAL_SRC_PATH)tcc_dxb_multi2_sw.c
...
ifdef 	LOCAL_COPY_LIB	
	...
	$(call build-copy-to-lib,$(LOCAL_TARGET)$(STATIC),$(LOCAL_MIDDLEWARE_PATH)common/dxb_swmulti2/lib)
